<!-- Slide d'image, récupère toutes les photos sauf celle actuellement affichée -->
<div class="gallery-slide">
    <?php 
    $exclude_post_id = get_the_ID(); // Récupérer l'ID du post actuel
    $slider_args = array(
        'post_type' => 'photo',
        'posts_per_page' => -1, // Récupére toutes les photos
    ...
    <?php
        wp_reset_postdata(); // Réinitialise les données de la requête principale
    endif;
    ?>
</div>
</div>
